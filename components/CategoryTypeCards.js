    ...
    <div className="container mx-auto p-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white text-gray-900 p-6 rounded-2xl border-2 border-blue-300 shadow-lg transform transition-transform hover:scale-105 hover:shadow-xl">
          <h2 style={{fontFamily: 'LeagueSpartan, sans-serif'}} className="text-xl font-semibold mb-4 border-b border-blue-300 pb-2">Category Totals</h2>
        ...
        {/* Type Totals Card */}
        <div className="bg-white text-gray-900 p-6 rounded-2xl border-2 border-blue-300 shadow-lg transform transition-transform hover:scale-105 hover:shadow-xl">
          <h2 style={{fontFamily: 'LeagueSpartan, sans-serif'}} className="text-xl font-semibold mb-4 border-b border-blue-300 pb-2">Type Totals</h2>
        ...
        <div className="bg-white text-gray-900 p-6 rounded-2xl border-2 border-blue-300 shadow-lg transform transition-transform hover:scale-105 hover:shadow-xl">
          <h2 style={{fontFamily: 'LeagueSpartan, sans-serif'}} className="text-xl font-semibold mb-4 border-b border-blue-300 pb-2">Conversation Directions</h2>
        ...
        <div className="bg-white text-gray-900 p-6 rounded-2xl border-2 border-blue-300 shadow-lg transform transition-transform hover:scale-105 hover:shadow-xl">
          <h2 style={{fontFamily: 'LeagueSpartan, sans-serif'}} className="text-xl font-semibold mb-4 border-b border-blue-300 pb-2">Summary</h2>
          <div className="mb-6">
            <p style={{fontFamily: 'LeagueSpartan, sans-serif'}} className="text-lg font-medium text-gray-700">Total Conversations:</p>
            <p className="text-2xl font-extrabold text-blue-700">{totalConversations}</p>
          </div>
          <div>
            <p style={{fontFamily: 'LeagueSpartan, sans-serif'}} className="text-lg font-medium text-gray-700">Total Cost:</p>
