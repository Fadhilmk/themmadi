          ...
          <div className="card">
            ...
            <div className="content">
              <div style={{ padding: 20, position: "relative", top: -40 }}>
                <h5
                  style={{ fontFamily: "LeagueSpartan, sans-serif" }}
                  className="mb-4 text-center text-xl font-medium text-gray-500 dark:text-black-400"
                >
                  Base plan
                </h5>
                ...
                <ul role="list" className="space-y-5 my-7">
                  <li className="flex items-center">
                    ...
                    <span
                      style={{ fontFamily: "LeagueSpartan, sans-serif" }}
                      className="ml-3 text-base font-normal leading-tight text-gray-500 dark:text-gray-400"
                    >
                      Upto 70% Open rate.
                    </span>
                  </li>
                  ...
                  <li className="flex items-center ">
                    ...
                    <span
                      style={{ fontFamily: "LeagueSpartan, sans-serif" }}
                      className="ml-3 text-base font-normal leading-tight text-gray-500"
                    >
                      Bulk contacts upload using excel sheet
                    </span>
                  </li>
                  <li className="flex items-center ">
                    <svg
                    ...
                    <span
                      ...
                      className="ml-3 text-base font-normal leading-tight text-gray-500"
                    >
                      Mange conversation directly on our platform
                    </span>
                  </li>
                  <li className="flex items-center ">
                    <svg
                    ...
                    <span
                      ...
                      className="ml-3 text-base font-normal leading-tight text-gray-500"
                    >
                      Analyze campaigns for better ROI
                    </span>
                  </li>
                  <li className="flex items-center ">
                    <svg
